...
export default function WeddingCountdown() {
  ...
  text-shadow:
    ...
    0 0 4px rgba(0,0,0,0.10);
        ...
        .wc-subtitle{ font-family:'Cormorant Garamond', serif; font-style:italic; color:#8b2a49; text-align:center; margin:0 0 8px; font-size:22px; font-weight:300; }
  ...
  .wc-number { font-size:32px; }
          ...
          .wc-card{ width: calc(100% - 20px); max-width:760px; margin: 5px auto; padding:20px; border-radius:16px; }
          .wc-title{ font-size:47px; margin-top:6px; line-height: 1.25; }
          .wc-date strong{ font-size:40px !important; }
          .wc-grid{ grid-template-columns: repeat(2, 1fr); gap:12px; margin-top:18px; }
          .wc-time-card{ padding:16px; border-radius:12px; }
          .wc-number{ font-size:32px }
